...
app.post('/spin', async (req, res) => {
    ...
    let symbolsByReel = [
        [1, 2, 9, 9, 4, 9, 9, 2, 4, 3, 4, 5, 6, 7, 8, 9],
        [1, 2, 2, 9, 4, 8, 9, 2, 3, 9, 9, 2, 5, 6, 7, 8, 9, 11, 13, 14],
        [1, 2, 8, 8, 4, 8, 8, 3, 4, 2, 5, 6, 7, 8, 9, 10, 11, 13, 14],
        [2, 3, 4, 5, 2, 2, 8, 8, 9, 9, 4, 6, 7, 8, 9, 10, 11],
        [3, 4, 5, 2, 6, 7, 8, 9, 11, 12],
    ];
...
app.get('/settings', async (req, res) => {
    res.json({
        ...
        settings: {
            ...
            scatterFreeSpins: [10, 15, 20],
            extraScatterTriggers: [3, 4, 5, 6],
            extraScatterFreeSpins: [5, 10, 15, 20],
            ...
            paytables: [
                {
                    type: 1,
                    patterns: [
                        { min: 8, max: 9, multiplier: 16.0 },
                        { min: 10, max: 11, multiplier: 40.0 },
                        { min: 12, max: 30, multiplier: 80.0 },
                    ],
                },
                {
                    type: 2,
                    patterns: [
                        ...
                        { min: 10, max: 11, multiplier: 16.0 },
                        { min: 12, max: 30, multiplier: 40.0 },
                    ],
                },
                {
                    type: 3,
                    patterns: [
                        { min: 8, max: 9, multiplier: 3.2 },
                        { min: 10, max: 11, multiplier: 8.0 },
                ...
                },
                {
                    type: 6,
                    patterns: [
                        { min: 8, max: 9, multiplier: 1.28 },
                        { min: 10, max: 11, multiplier: 2.4 },
                        { min: 12, max: 30, multiplier: 12.8 },
                    ],
                },
                {
                    type: 7,
                    patterns: [
                        { min: 8, max: 9, multiplier: 0.8 },
                        { min: 10, max: 11, multiplier: 1.6 },
                        { min: 12, max: 30, multiplier: 8.0 },
                    ],
                },
                {
                    type: 8,
                    patterns: [
                        { min: 8, max: 9, multiplier: 0.64 },
                        { min: 10, max: 11, multiplier: 1.44 },
                        { min: 12, max: 30, multiplier: 6.4 },
                    ],
                },
                {
                    type: 9,
                    patterns: [
                        { min: 8, max: 9, multiplier: 0.32 },
                        { min: 10, max: 11, multiplier: 1.12 },
                        { min: 12, max: 30, multiplier: 3.2 },
                    ],
                },
                {
                    type: 10,
